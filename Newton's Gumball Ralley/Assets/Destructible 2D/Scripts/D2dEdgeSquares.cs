...
namespace Destructible2D
{
	...
	public static class D2dEdgeSquares
	{
			...
			while (true)
			{
				...
				switch (square.Mask)
				{
					...
					case 1:
						if (side == Side.W)
						{
							ShiftS(square, end, ref x, ref y); square.Mask = 0; continue;
						}
						if (side == Side.S)
						{
							ShiftW(square, end, ref x, ref y); square.Mask = 0; continue;
						}
					break;
					...
					case 2:
						if (side == Side.S)
						{
							ShiftE(square, end, ref x, ref y); square.Mask = 0; continue;
						}
						if (side == Side.E)
						{
							ShiftS(square, end, ref x, ref y); square.Mask = 0; continue;
					...
					case 4:
						...
						if (side == Side.W)
						{
							ShiftN(square, end, ref x, ref y); square.Mask = 0; continue;
						}
					break;
					case 5:
						if (side == Side.N)
					...
					case 6:
						if (side == Side.N)
						{
							ShiftW(square, end, ref x, ref y); square.Mask = 2; continue;
						}
						if (side == Side.W)
						{
							ShiftN(square, end, ref x, ref y); square.Mask = 2; continue;
						}
						if (side == Side.S)
						{
							ShiftE(square, end, ref x, ref y); square.Mask = 4; continue;
						}
						if (side == Side.E)
						{
							ShiftS(square, end, ref x, ref y); square.Mask = 4; continue;
						}
					break;
					case 7:
						if (side == Side.N)
					...
					case 9:
						if (side == Side.E)
						{
							ShiftN(square, end, ref x, ref y); square.Mask = 1; continue;
						}
						if (side == Side.N)
						{
							ShiftE(square, end, ref x, ref y); square.Mask = 1; continue;
						}
						if (side == Side.W)
						{
							ShiftS(square, end, ref x, ref y); square.Mask = 8; continue;
						}
						if (side == Side.S)
						{
							ShiftW(square, end, ref x, ref y); square.Mask = 8; continue;
						}
						break;
					case 10:
						if (side == Side.S)
		...
		private static void ShiftN(Square square, bool end, ref int x, ref int y)
		{
			AddPoint(square.PointN, end); y++;
		}

		private static void ShiftS(Square square, bool end, ref int x, ref int y)
		{
			AddPoint(square.PointS, end); y--;
		}

		private static void ShiftE(Square square, bool end, ref int x, ref int y)
		{
			AddPoint(square.PointE, end); x++;
		}

		private static void ShiftW(Square square, bool end, ref int x, ref int y)
		{
			AddPoint(square.PointW, end); x--;
		}
