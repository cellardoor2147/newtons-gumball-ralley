...
namespace Destructible2D.Examples
{
	...
	[HelpURL(D2dHelper.HelpUrlPrefix + "D2dTapToRead")]
	[AddComponentMenu(D2dHelper.ComponentMenuPrefix + "Tap To Read")]
	public class D2dTapToRead : MonoBehaviour
	{
		...
		private void ReadNow(D2dInputManager.Finger finger)
		{
			...
			if (camera != null)
			{
				...
				var position = D2dHelper.ScreenToWorldPosition(finger.ScreenPosition, Intercept, camera);
...
namespace Destructible2D.Examples
{
	...
	public class D2dTapToRead_Editor : D2dEditor
	{
