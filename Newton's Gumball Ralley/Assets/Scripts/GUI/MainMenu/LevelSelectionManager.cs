...
namespace GUI.MainMenu
{
    public class LevelSelectionManager : MonoBehaviour
    {
        ...
        private static readonly string BUTTONS_FOR_WORLDS_PREFIX =
            "Buttons for Worlds ";
        private static readonly string WORLDS_1_AND_2_SUFFIX =
            "1 and 2";
        ...
        private GameObject buttonsForWorlds1And2;
        ...
        private void Awake()
        {
            ...
            buttonsForWorlds1And2 =
                transform.Find(BUTTONS_FOR_WORLDS_PREFIX  + WORLDS_1_AND_2_SUFFIX).gameObject;
        ...
        public void ShowLevelsLeft()
        {
            if (buttonsForWorlds3And4.activeSelf)
            {
                ...
                buttonsForWorlds1And2.SetActive(true);
        ...
        {
            if (buttonsForWorlds1And2.activeSelf)
            {
                SetAllButtonsForWorldsContainersToInactive();
                buttonsForWorlds3And4.SetActive(true);
        ...
        {
            buttonsForWorlds1And2.SetActive(false);
